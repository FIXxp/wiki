---
description: Описание конфигурации лаунчсервера
---
# Конфигурация
...
`protectHandler` - отвечает за выдачу токенов(accessToken) [Настройка ProtectHandler](/guide/configuration.md#настройка-protecthandler)  
